...
import fit.iuh.kredoshopbe.dto.response.CategoryResponse;
import fit.iuh.kredoshopbe.dto.response.ProductResponse;
import fit.iuh.kredoshopbe.dto.response.ProductResponse.SizeDetailResponse;
import fit.iuh.kredoshopbe.dto.response.TopProductResponse;

import fit.iuh.kredoshopbe.entities.Category;
...
import fit.iuh.kredoshopbe.enums.Status;
import fit.iuh.kredoshopbe.exception.AppException;
import fit.iuh.kredoshopbe.exception.ErrorCode;
import fit.iuh.kredoshopbe.mapper.ProductMapper;
import fit.iuh.kredoshopbe.repository.CategoryRepository;
